...
export function Button({
  ...
  const variants = {
    ...
    outline: 'border border-neutral-200 text-neutral-700 hover:border-neutral-300 hover:bg-neutral-50 focus:ring-neutral-200',
    ghost: 'text-neutral-600 hover:bg-neutral-100 hover:text-neutral-900 focus:ring-neutral-200',
  };
